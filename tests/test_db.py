...
@pytest.mark.asyncio
async def test_get_session_success(test_db):
...
@pytest.mark.asyncio
async def test_get_session_retry_on_operational_error(test_db):
...
@pytest.mark.asyncio
async def test_get_session_exhausts_retries():
...
@pytest.mark.asyncio
async def test_get_session_exponential_backoff(test_db):
...
def test_get_async_database_url_postgresql_psycopg():
...
def test_get_async_database_url_other():
...
@pytest.mark.asyncio
async def test_large_telegram_id(test_db):
